...
#
# Created: Thu Feb 13 14:45:14 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setMinimumSize(QtCore.QSize(880, 600))
        ...
        self.plotter = SpectrumPlotter(self.splitter)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.plotter.sizePolicy().hasHeightForWidth())
        self.plotter.setSizePolicy(sizePolicy)
        self.plotter.setFrameShape(QtGui.QFrame.StyledPanel)
        self.plotter.setFrameShadow(QtGui.QFrame.Raised)
        ...
        QtCore.QObject.connect(self.peptide_hits, QtCore.SIGNAL(_fromUtf8("clicked(QModelIndex)")), self.plotter.repaint)
